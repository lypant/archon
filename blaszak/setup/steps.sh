...
{
    log "Set host name..."
    archChroot "echo blaszak > /etc/hostname"
...
setWiredNetwork()
{
    ...
    archChroot "systemctl enable dhcpcd@enp0s7.service"
...
{
    local configDir="/root/archon/blaszak/config"
...
configureMtpTools()
{
    ...
    local configDir="/home/adam/archon/blaszak/config"
...
{
    local srcDir="/home/adam/archon/blaszak/dotfiles/.config/systemd/user"
...
copyProjectLogFiles()
{
    cp -r ../logs /home/adam/archon/blaszak
}
