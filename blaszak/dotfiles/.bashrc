...
export PATH=$PATH:$HOME/archon/blaszak/bin

# Script for entering sudo password using dmenu
export SUDO_ASKPASS="/home/adam/archon/blaszak/bin/dmenu_passwd"
...
if [[ -z "$DISPLAY" ]]; then
    ...
    alias mc='EDITOR=vim VIEWER=$HOME/archon/blaszak/bin/mc_viewer mc -a'
else
    # Aliases for GUI

    # Use vim as editor
    # Use mc_viewer script as viewer - vim with additional parameters
    alias mc='EDITOR=vim VIEWER=$HOME/archon/blaszak/bin/mc_viewer mc'
fi
...
source "$HOME/archon/blaszak/colors/solarized/bash.conf"
