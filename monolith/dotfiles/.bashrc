...
if [[ -z "$DISPLAY" ]]; then
    ...
    alias mc='EDITOR=vim VIEWER=$HOME/archon/monolith/scripts/mc_viewer.sh mc -a'
else
    # Aliases for GUI

    # Use vim as editor
    # Use mc_viewer.sh script as viewer - vim with additional parameters
    alias mc='EDITOR=vim VIEWER=$HOME/archon/monolith/scripts/mc_viewer.sh mc'
fi
...
export PATH=$PATH:/$HOME/archon/monolith/scripts
...
if [[ "$CONSOLE_THEME" = "solarized" ]]; then
    ...
    CONSOLE_COLOR_BLACK=$SOLARIZED_BASE3
    ...
    CONSOLE_COLOR_WHITE=$SOLARIZED_BASE02
    CONSOLE_COLOR_BR_BLACK=$SOLARIZED_BASE2
    CONSOLE_COLOR_BR_RED=$SOLARIZED_ORANGE
    CONSOLE_COLOR_BR_GREEN=$SOLARIZED_BASE1
    CONSOLE_COLOR_BR_YELLOW=$SOLARIZED_BASE0
    CONSOLE_COLOR_BR_BLUE=$SOLARIZED_BASE00
    CONSOLE_COLOR_BR_MAGNETA=$SOLARIZED_VIOLET
    CONSOLE_COLOR_BR_CYAN=$SOLARIZED_BASE01
    CONSOLE_COLOR_BR_WHITE=$SOLARIZED_BASE03
